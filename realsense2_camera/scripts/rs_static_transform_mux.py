...
class StaticTransformMux():
    ...
    def __init__(self):
        ...
        self._tf_static_sub_name = rospy.get_param("~tf_static_subscriber_name", "/tf_static_realsense")
        ...
        self._tf_subscriber = rospy.Subscriber(self._tf_static_sub_name, TFMessage, self.tf_static_cb, queue_size=100)
...
if __name__ == '__main__':
    rospy.init_node('rs_static_transform_mux')
